...
public class AnotherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (position == 0) {
            ...
            description.setText(aDescription="As human beings please support us to promote clean water and sanitation.Help protect and preserve our environment (including wildlife) Protect and Preserve the cultural heritage of our indigenous peoples");
